...
_PREFERENCE_INSTRUCTION = (
    ...
    "Write 1-3 sentences using the phrasing 'The user would prefer ...' "
    "(and optionally 'They would not prefer ...'). "
    "Do NOT end with a 'Final answer:' line for this question type. "
    "Do NOT abstain when relevant context is present.\n\n"
    "CRITICAL grounding rules:\n"
    "(a) Reference the specific items, brands, names, places, dates, and "
    "events the user mentioned IN THE EVIDENCE BY NAME. If the user said "
    "'lemon poppyseed cake', say 'lemon poppyseed cake' — do not paraphrase "
    "it as 'a lemon cake' or substitute 'lemon lavender cake'. If the user "
    "said 'turbinado sugar', say 'turbinado sugar' — do not generalize to "
    "'a different sugar'. Names of pets, cities, gear models, and apps must "
    "appear verbatim when the evidence supplies them.\n"
    "(b) Build directly on what the user said about THIS topic. Do not "
    "extrapolate to unrelated domains — if the question is about phone "
    "battery tips, do not talk about travel organisation; if the question "
    "is about hotels in Miami, do not reuse details from a Seattle trip.\n"
    "(c) Do NOT invent items the user did not actually mention. If the "
